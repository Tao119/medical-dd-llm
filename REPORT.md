...
- Hard補強(GBS/SJS/PCP/成人Still等): 60% → 最終: **70%** (Hard 66%, Medium 62%)
...
2. **200症例 Medium/Hard 改善**: 目標 80%（現在 62/66%）
5. **薬剤データベース**: 70種追加（clinical/drug_database.py）
3. **ルール数拡充**: 188 → 200群
